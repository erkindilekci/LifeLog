package com.erkindilekci.addedit.navigation
...
import com.erkindilekci.addedit.AddEditScreen
import com.erkindilekci.addedit.AddEditViewModel
import com.erkindilekci.util.Constants
import com.erkindilekci.util.Screen
import com.erkindilekci.util.model.Mood

@OptIn(ExperimentalFoundationApi::class)
fun NavGraphBuilder.addEditRoute(
    onBackClicked: () -> Unit
) {
    composable(
